...
const Footer = () => {
  return (
    <footer className=" bg-PrimaryColor text-black rounded-t-3xl mt-8 md:mt-0">
        ...
        <div className=" w-full md:w-1/4">
          ...
          <nav className=" flex flex-col gap-2">
            <Link to="/" spy={true} smooth={true} duration={500}>
              Pakistan Sindh Tando Adam
            </Link>
            <Link to="/" spy={true} smooth={true} duration={500}>
              Jairamofficail@gmail.com
            </Link>
            <Link to="/" spy={true} smooth={true} duration={500}>
              +923033355927
            </Link>
      ...
      <div>
        <p className=" text-center py-4">
          ...
          <span className="text-red-500">JaiKumar Programmers</span> | All
          rights reserved
        </p>
      </div>
    </footer>
